	...
	public static String wildAttack(String player_id,String uid,String attackId,String wildId){
		...
		try(Connection conn = DriverManager.getConnection(DB,Name,Password);
			...
			if(attackId.equals("0") || r2.getInt(5)>0) {
				...
				if(!attackId.equals("0"))
					UserDoneDamage =(int) (((((2*Level1/5.0)+2)*r2.getInt(2)*(Attack1/Defense2)/50)+2)*(ThreadLocalRandom.current().nextInt(850, 1000)/1000.0));
				...
				System.out.println(((((2*Level1/5.0)+2)*r2.getInt(2)*(Attack1/Defense2)/50)+2));
				System.out.println(((((2*Level2/5.0)+2)*r4.getInt(3)*(Attack2/Defense1)/50)+2));
